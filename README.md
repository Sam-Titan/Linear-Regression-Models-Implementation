...
Predicted Scores: [22.799999999999997, 41.8, 60.8, 79.8, 98.8, 117.8, 136.8, 155.8, 174.8, 193.8]   
Comparing with the actual scores: [18, 42, 58, 77, 95, 123, 135, 162, 175, 198]
...
The graph for the same can be found in the repo under the name Linear_Regression_Noise_Outliers_Using_Mathamatical_Formulas

2. Linear Regression using sklearn
Results:
Slope (Coefficient): 19.836363636363636
Intercept: -0.7999999999999972
Predicted Scores: [ 19.03636364  38.87272727  58.70909091  78.54545455  98.38181818
...
The graph for the same can be found in the repo under the name Linear_Regression_Noise_Outliers_Graph
...
Predicted values: [131.34912718 330.4353548  254.86061849 208.78904181  55.84311228
...
The graph for the same can be found in the repo under the name Linear_Regression_Random_Dataset_Graph
